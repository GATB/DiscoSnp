...
CI_URL=https://ci.inria.fr/gatb-core/view/DiscoSnp-gitlab/job
...
uploadFile ${ARCHIVE_NAME}-${BRANCH_TO_BUILD}-bin-Linux.tar.gz
uploadFile ${ARCHIVE_NAME}-${BRANCH_TO_BUILD}-bin-Darwin.tar.gz
uploadFile ${ARCHIVE_NAME}-${BRANCH_TO_BUILD}-Source.tar.gz
