...
print "read genomes"
filein= open("first10M.chr1.phase1_release_v3.20101123.snps_indels_svs.genotypes_indivs_HG00096_HG00100_no_overlapping_indels.vcf","r")
refgenome=str(list(SeqIO.parse("humch1_first_10M.fasta", "fasta"))[0].seq)
