...
Nous allons utiliser des jeux de données et des outils spécifiques à ce TP. Voici les commandes à utiliser afin d'utiliser correctement ces ressources:
        \code{wget \url{http://igm.univ-mlv.fr/~peterlon/tp_installer.sh}}
...
\qu \ding{253} Lancez \discopp sur les reads humains en ne recherchant que des SNP \emph{proches}.
